<nav x-data="{ open: false }" class="bg-white border-b border-gray-200 sticky top-0 z-20">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            @guest
                <div class="flex flex-col gap-1.5 px-4 py-2">
                    <a href="{{ route('login') }}">
                        <x-secondary-button class="w-full justify-center">{{ __('Log in') }}</x-secondary-button>
                    </a>
                    <a href="{{ route('register') }}">
                        <x-primary-button class="w-full justify-center">{{ __('Sign Up') }}</x-primary-button>
                    </a>
                </div>
            @endguest
        </div>
